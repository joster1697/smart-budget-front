  ...
  return (
    <div className="flex flex-col gap-3 mt-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4 ">
        {/* Tax Optimization */}
        <div className="flex-1 bg-[#fbfdfc] border-2 border-outline-variant/30 rounded-xl p-5 flex gap-3 hover:border-primary-fixed cursor-pointer transition-all duration-300 hover:shadow-md">
      ...
      {/* Security Settings */}
      <div className="w-full bg-[#fbfdfc] border-2 border-outline-variant/30 rounded-xl p-5 flex items-start gap-5 hover:border-primary-fixed cursor-pointer transition-all duration-300 hover:shadow-md">
        ...
        <div className="flex flex-col justify-center h-11">
          ...
          <p className="text-[13px] text-[#424943] mt-1.5">
