  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col relative w-full lg:max-w-[calc(100vw-280px)] bg-gradient-to-b from-primary/10 via-background to-background">
        ...
        <main className={`flex-1 overflow-x-hidden pt-20 lg:pt-10 px-4 lg:px-10 space-y-6 lg:space-y-8 transition-all duration-500 ${isCollapsed ? "pb-24 lg:pb-32" : "pb-60 lg:pb-32"}`}>
          <Outlet />
        </main>
        <div className="lg:hidden">
